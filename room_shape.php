	...
	if ($active==TRUE) {
		...
		'<div id="room-'.$number.'" class="active-room span'.$size.'">
			...
			<div id="'.$number.'-radio" class="btn-group" data-toggle="buttons-radio">
				...
				<button type="button" id="'.$number.'-radio-3" class="btn btn-mini active">3</button>
				<button type="button" id="'.$number.'-radio-4" class="btn btn-mini">4</button>
				<button type="button" id="'.$number.'-radio-5" class="btn btn-mini">5</button>
			</div>
